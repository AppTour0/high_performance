...
class AlarmHomePage2 extends StatefulWidget {
  @override
  _AlarmHomePage2State createState() => _AlarmHomePage2State();
}

class _AlarmHomePage2State extends State<AlarmHomePage2> {
  Future test() async {
